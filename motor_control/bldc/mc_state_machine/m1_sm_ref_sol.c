...
extern mcdrv_ctimer_cmt_t g_sM1CmtTmr;

/*! @brief Main application switch */
bool_t g_bM1SwitchAppOnOff;

/*! @brief M1 structure */
run_substate_t s_eM1StateRun;
...
static void M1_StateInitFast(void)
{
    ...
    g_sM1Drive.ui16FreqCtrlLoop = M1_PWM_FREQ;
...
static void M1_StateRunFast(void)
{
    ...
    *g_sM1CmtTmr.pui16CtimerCntAct      = CTIMER1->TC;
    *g_sM1CmtTmr.pui16CtimerMatchAct    = CTIMER1->MR[1];
    ...
    adc_cmdl_temp       = ADC0->CMD[0].CMDL;
    adc_cmdl_temp       &=(~ADC_CMDL_ADCH_MASK);
    ...
    switch (g_sM1AdcSensor.ui16Sector)
    {
        ...
        case 0:
        case 3:
          adc_cmdl_temp |=ADC_CMDL_ADCH(2U);
          break;
          
        /* BEMF phase B sensing */
        case 1:
        case 4:
          adc_cmdl_temp |=ADC_CMDL_ADCH(21U);
          break;
          
        /* BEMF phase A sensing */
        case 2:
        case 5:
          adc_cmdl_temp |=ADC_CMDL_ADCH(20U);
          break;
          
        default:
          break;
    }
    ADC0->CMD[0].CMDL   = adc_cmdl_temp;
...
static void M1_TransInitFault(void)
{
    ...
    /* disable PWM outputs */
    MCDRV_eFlexPwm3PhOutDis(&g_sM1Pwm3ph);
...
static void M1_StateRunCalibFast(void)
{
    ...
    if (++g_sM1Drive.sCtrlBLDC.i16SectorCmt > 5)
    {
      g_sM1Drive.sCtrlBLDC.i16SectorCmt = 0;
    }
    ...
    switch (g_sM1AdcSensor.ui16Sector)
    {
        ...
        case 0:
        case 3:
          g_sM1AdcSensor.ui16CalibBemfPhC=
            (uint16_t)GDFLIB_FilterMA_F16((frac16_t)g_sM1Drive.sCtrlBLDC.f16UPhase, &g_sM1AdcSensor.ui16FiltBemfPhC);            
          break;
          
        /* BEMF phase B sensing */
        case 1:
        case 4:
          g_sM1AdcSensor.ui16CalibBemfPhB=
            (uint16_t)GDFLIB_FilterMA_F16((frac16_t)g_sM1Drive.sCtrlBLDC.f16UPhase, &g_sM1AdcSensor.ui16FiltBemfPhB);      
          break;
          
        /* BEMF phase A sensing */
        case 2:
        case 5:
          g_sM1AdcSensor.ui16CalibBemfPhA=
            (uint16_t)GDFLIB_FilterMA_F16((frac16_t)g_sM1Drive.sCtrlBLDC.f16UPhase, &g_sM1AdcSensor.ui16FiltBemfPhA); 
          break;
    ...
    g_sM1AdcSensor.ui16CalibDcCurr =
      (uint16_t)GDFLIB_FilterMA_F16((frac16_t)g_sM1Drive.sCtrlBLDC.f16IDcBusNoFilt, &g_sM1AdcSensor.ui16FiltDcCurr);
}
...
static void M1_StateRunCalibSlow(void)
{
    ...
    if (--g_sM1Drive.ui16CounterState == 0)
    {
        ...
        g_sM1AdcSensor.ui16OffsetDcCurr = g_sM1AdcSensor.ui16CalibDcCurr;
        
        g_sM1AdcSensor.ui16OffsetBemfPhA = g_sM1AdcSensor.ui16CalibBemfPhA;
        g_sM1AdcSensor.ui16OffsetBemfPhB = g_sM1AdcSensor.ui16CalibBemfPhB;
        g_sM1AdcSensor.ui16OffsetBemfPhC = g_sM1AdcSensor.ui16CalibBemfPhC;
...
static void M1_StateRunSpinFast(void)
{
    ...
    if ((uint16_t)MLIB_SubSat_F16(g_sM1Drive.ui16TimeCurrent, g_sM1Drive.ui16TimeOfCmt) >= g_sM1Drive.ui16PeriodToff)
    {
        ...
        if (g_sM1Drive.f32UBemfIntegSum >= g_sM1Drive.f32UBemfIntegThreshold)
        {
            ...
            MCDRV_eFlexPwmSetPwmOutput(&g_sM1Pwm3ph, g_sM1Drive.sCtrlBLDC.i16SectorCmt, g_sM1Drive.sCtrlBLDC.ui16MotorDir);
...
static void M1_StateRunSpinSlow(void)
{
    ...
    /* update duty cycle */
    MCDRV_eFlexPwm3PhSet(&g_sM1Pwm3ph, g_sM1Drive.sCtrlBLDC.f16DutyCycle);
...
static void M1_TransRunReadyAlign(void)
{
    ...
    g_sM1Drive.sCtrlBLDC.f16DutyCycle = FRAC16(0.5);

    /* update PWM duty cycle and set sector */
    M1_MCDRV_PWM3PH_SET_DUTY(&g_sM1Pwm3ph, g_sM1Drive.sCtrlBLDC.f16DutyCycle);

    M1_MCDRV_PWM3PH_SET_PWM_OUTPUT(&g_sM1Pwm3ph);
    
    MCDRV_eFlexPwmSetPwmOutput(&g_sM1Pwm3ph, 6U, 0);
